  ...
  return (
    ...
    >
      ...
      <div className="relative">
        <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-violet-500 to-fuchsia-500 flex items-center justify-center mb-4 shadow-lg shadow-violet-500/25">
  ...
  const features = [
    {
      ...
      description: "Crop, resize, rotate, and enhance your images with powerful AI-assisted tools.",
    },
    {
      icon: Wand2,
      title: "AI Background Removal",
      description: "Instantly remove backgrounds from any image with our advanced Gemini AI integration.",
    },
    {
      icon: Sparkles,
      title: "Logo Extraction",
      description: "Extract and isolate logos from images automatically using AI vision technology.",
    },
    {
      icon: Video,
      title: "Video Tools",
      description: "Coming soon: AI-powered video editing and generation capabilities.",
    },
    {
      icon: Zap,
    ...
    },
    {
      ...
      description: "Enterprise-grade security and reliability for your creative workflow.",
    },
  ];
        ...
        <div className="max-w-6xl mx-auto">
          ...
          >
            ...
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
              Everything you need to transform your images and bring your creative vision to life.
            </p>
          </motion.div>
          ...
          >
            ...
            <div className="relative">
              ...
              <p className="text-lg text-muted-foreground mb-8 max-w-xl mx-auto">
                Join thousands of creators using Pupa AI Studio to bring their ideas to life.
              </p>
              <Link href="/sign-up">
                <Button variant="gradient" size="xl" className="group">
                  Start Creating Now
