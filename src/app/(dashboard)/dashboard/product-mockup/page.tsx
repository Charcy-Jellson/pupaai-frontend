          ...
          >
            ...
            <Alert className="bg-violet-500/10 border-violet-500/30 mb-6">
              ...
              <AlertDescription className="text-sm text-muted-foreground">
                <strong className="text-violet-300">Step 1:</strong> Select a
                product image and logo, position the logo, then generate a
                preview to confirm the placement looks good.
              </AlertDescription>
            </Alert>
                  ...
                  {state.firstMockup && (
                    ...
                    >
                      <Card className="bg-green-500/10 border-green-500/30">
                        ...
                        <CardContent className="space-y-3">
                          <p className="text-sm text-muted-foreground">
                            Does the logo placement look good? If so, continue
                            to select colors.
                          </p>
                          <Button
                          ...
                          >
                            ...
                            Confirm & Select Colors
                          </Button>
                          <p className="text-xs text-muted-foreground text-center">
                            Not happy? Adjust the position and regenerate.
                          </p>
                        </CardContent>
                      </Card>
                    </motion.div>
            ...
            {!state.firstMockup && (
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-8">
                ...
                <TipCard
                  ...
                  description="AI creates a mockup to confirm placement"
                />
              </div>
            )}
          </motion.div>
        ...
        {state.phase === "recolor" && (
          ...
          >
            ...
            <Alert className="bg-fuchsia-500/10 border-fuchsia-500/30 mb-6">
              ...
              <AlertDescription className="text-sm text-muted-foreground">
                <strong className="text-fuchsia-300">Step 2:</strong> Select one
                or more colors, then generate all color variants at once. The AI
                will change the product color while keeping your logo intact.
              </AlertDescription>
            </Alert>
                      ...
                      {state.isProcessing ? (
                        <>
                          <motion.div
                            ...
                            className="w-4 h-4 mr-2 border-2 border-white/30 border-t-white rounded-full"
                          />
                          Generating {state.processingCount} variant
                          {state.processingCount !== 1 ? "s" : ""}...
                        </>
                      ) : (
                        <>
                          <Sparkles className="w-4 h-4 mr-2" />
                          Generate {state.selectedColors.length} Variant
